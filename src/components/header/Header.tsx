...
const Header = () => {
    return (
        <div className={styles.container}>
            <h2 className={styles.logo}>Busyboard</h2>
            ...
            <div className={styles.user_container}>
                ...
                <div className={styles.user_logo}><svg width="24" height="24" viewBox="0 0 24 24" fill="black" xmlns="http://www.w3.org/2000/svg">
